...
update-dependencies:  ## update all development dependencies
	pip install -U pip
	pip install --extra-index-url https://pypi.fury.io/dharpa/--extra-index-url --extra-index-url https://gitlab.com/api/v4/projects/25344049/packages/pypi/simple -U -e '.[all_dev]'
